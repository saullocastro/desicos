...
project = 'DESICOS'
copyright = '2012-2020 Desicos Improved Software Team'

# The default replacements for |version| and |release|, also used in various
# other places throughout the built documents.
#
# The short X.Y version.
version = desicos.__version__
...
texinfo_documents = [
    (master_doc, 'desicos', 'DESICOS Documentation',
                 'DESICOS Improved Software Team',
   'DESICOS', 'DESICOS', 'Programming', 1),
]
