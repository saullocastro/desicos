...
class TestDB(AFXDataDialog):
    ...
    def __init__(self, form):
        ...
        FXLabel(bcVAbot, '')
        FXLabel(bcVAbot, '')
        self.rrbot = FXCheckButton(bcVAbot, 'Include Resin Ring Bottom' , form.resin_ring_bottomKw)
        FXLabel(bcVAbot, '')
        FXLabel(bcVAbot, '')
        ...
        FXLabel(bcVAtop, '')
        FXLabel(bcVAtop, '')
        self.rrtop = FXCheckButton(bcVAtop, 'Include Resin Ring Top' , form.resin_ring_topKw)
        FXLabel(bcVAtop, '')
        FXLabel(bcVAtop, '')
