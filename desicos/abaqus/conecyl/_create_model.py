...
from create_sets_ort import *
from create_sets_str import *
    ...
    if cc.geo_STR_CB==False and cc.geo_cs_RB==False and cc.geo_ort_RB==False and cc.geo_ccs_RB==False:
        ...
        if  cc.geo_F_CB==False :
            ...
            if cc.pressure_load:
                ...
                Face_temp = part_shell.sets['part_shell_str'].faces
                part_shell.Surface(side2Faces=Face_temp, name='Shell_str_surf')

                Face_temp = part_shell.sets['part_shell_str_1'].faces
                part_shell.Surface(side1Faces=Face_temp, name='Str_1_surf_1')
            ...
            if cc.geo_i_str_RB==True or cc.geo_z_str_RB==True:
                ...
                if cc.geo_i_str_RB==True:
                    ...
                    THICKNESS=[cc.plyts[0],cc.geo_Z_str[3]+cc.plyts[0],cc.geo_Z_str[4],cc.geo_Z_str[5]]
                    offt1=((cc.geo_Z_str[3]+0.0)/2)/(cc.geo_Z_str[3]+cc.plyts[0])
                    OFFT=[0.0,offt1,0.0,0.0]
            else:
                GEO=[Skin, Stringers, Stringers_1]
                NAMES=['Skin', 'Stringers', 'Stringers_1']
                THICKNESS=[cc.plyts[0],cc.geo_w_str[2]+cc.plyts[0],cc.geo_w_str[3]]
        ...
        if cc.pressure_load:
            ...
            Face_temp = part_shell.sets['part_shell_str'].faces
            part_shell.Surface(side1Faces=Face_temp, name='Str_surf_1')

            part_shell.Surface(side2Faces=Face_temp, name='Str_surf_2')

            Face_temp = part_shell.sets['part_shell_frames'].faces
            part_shell.Surface(side1Faces=Face_temp, name='Frames_1_surf')
            part_shell.Surface(side2Faces=Face_temp, name='Frames_2_surf')


        GEO=[Skin, Stringers, Frames]
...
def _create_loads_bcs(cc):
    ...
    # creating stringers
    for stringer in cc.stringerconf.stringers:
        stringer.create()
...
#               set_shell_faces = ra.sets['shell_faces']            
                ...
                if  cc.geo_F_CB==False :
                    ...
                    createStepName=cc.get_step_name(cc.pressure_step),
                    region=region_1, magnitude=cc.pressure_load)
                    region_2=ra.instances[ra.instances.items()[0][0]].surfaces['Shell_str_surf']
                    mod.Pressure(name='pressure_2',
                    createStepName=cc.get_step_name(cc.pressure_step),
                    region=region_2, magnitude=cc.pressure_load)
                    region_3=ra.instances[ra.instances.items()[0][0]].surfaces['Str_1_surf_1']
                    mod.Pressure(name='pressure_3',
                    createStepName=cc.get_step_name(cc.pressure_step),
                    region=region_3, magnitude=cc.pressure_load)
                    region_4=ra.instances[ra.instances.items()[0][0]].surfaces['Str_1_surf_2']
                    ...
                    if cc.geo_i_str_RB==True or cc.geo_z_str_RB==True:
                        ...
                        createStepName=cc.get_step_name(cc.pressure_step),
                        region=region_5, magnitude=cc.pressure_load)
                        region_6=ra.instances[ra.instances.items()[0][0]].surfaces['Str_2_surf_2']
                        mod.Pressure(name='pressure_6',
                        createStepName=cc.get_step_name(cc.pressure_step),
                        region=region_6, magnitude=cc.pressure_load)
                    else:
                        pass
                else:
                ...
                createStepName=cc.get_step_name(cc.pressure_step),
                region=region_1, magnitude=cc.pressure_load)
                region_2=ra.instances[ra.instances.items()[0][0]].surfaces['Str_surf_1']
                mod.Pressure(name='pressure_2',
                createStepName=cc.get_step_name(cc.pressure_step),
                region=region_2, magnitude=cc.pressure_load)
                region_3=ra.instances[ra.instances.items()[0][0]].surfaces['Str_surf_2']
                mod.Pressure(name='pressure_3',
                createStepName=cc.get_step_name(cc.pressure_step),
                region=region_3, magnitude=cc.pressure_load)
                region_4=ra.instances[ra.instances.items()[0][0]].surfaces['Frames_1_surf']
                mod.Pressure(name='pressure_4',
                createStepName=cc.get_step_name(cc.pressure_step),
                region=region_4, magnitude=cc.pressure_load)
                region_5=ra.instances[ra.instances.items()[0][0]].surfaces['Frames_2_surf']
                mod.Pressure(name='pressure_5',
                createStepName=cc.get_step_name(cc.pressure_step),
                region=region_5, magnitude=cc.pressure_load)
#End new pressure
