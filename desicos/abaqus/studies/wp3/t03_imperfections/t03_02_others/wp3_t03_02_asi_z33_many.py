...
bs = [50.]
for b in bs:
    study_name = 'wp3_t03_02_asi_z33_many_b_%03d' % int(b)
    ###########################################
    ...
    wbs = [ 0.08, 0.16, 0.24, 0.32, 0.40, 0.48, 0.72,
            0.80, 0.88, 1.32, 2.00, 2.64, 0.04, 3.82, 5. ]
    for wb in wbs:
        ...
        cc.impconf.ploads = []
        cc.impconf.add_axisymmetric( 0.2, b, wb )
        cc.impconf.add_axisymmetric( 0.3, b, wb )
        cc.impconf.add_axisymmetric( 0.4, b, wb )
        cc.impconf.add_axisymmetric( 0.5, b, wb )
        cc.impconf.add_axisymmetric( 0.6, b, wb )
        cc.impconf.add_axisymmetric( 0.7, b, wb )
        cc.impconf.add_axisymmetric( 0.8, b, wb )
        cc.numel_r    = 120.
        cc.elem_type  = 'S8R5'
        cc.axial_displ = 1.
    std.create_models()
